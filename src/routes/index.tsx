...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "ALogicData — Interactive SCORM Learning Platform" },
      {
        name: "description",
        content:
...
function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background pb-24 lg:pb-28 ">
      <Header />
...
/>
   ...
   <section
  id="cta"
  className="fixed bottom-0 left-0 right-0 z-50 border-t border-border/70 bg-background/95 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] backdrop-blur-md"
>
  <div className="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex items-center gap-3">
        <div
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-primary-foreground shadow-[var(--shadow-soft)]"
          style={{ backgroundImage: "var(--gradient-primary)" }}
        >
        ...
        <div>
          ...
          <p className="hidden text-xs text-muted-foreground sm:block">
            Talk to our experts or schedule a meeting.
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-2 sm:gap-3">
        <Button
          asChild
          variant="outline"
          className="h-9 border-primary/30 px-3 text-xs text-primary hover:bg-primary/5 sm:text-sm"
        >
